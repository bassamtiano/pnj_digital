...
Route::get('admin_inventaris/baca/inventaris_civitas', array('as' => 'admin_inventaris_baca_inventaris_civitas', 'uses' => 'AdminInventarisController@admin_inventaris_baca_inventaris_civitas'));

Route::get('admin_inventaris/baca/inventaris_jurusan', array('as' => 'admin_inventaris_baca_inventaris_jurusan', 'uses' => 'AdminInventarisController@admin_inventaris_baca_inventaris_jurusan'));

Route::get('admin_inventaris/baca/inventaris_program_studi', array('as' => 'admin_inventaris_baca_inventaris_program_studi', 'uses' => 'AdminInventarisController@admin_inventaris_baca_inventaris_program_studi'));
...
Route::get('admin_inventaris/tambah/inventaris_civitas', array('as' => 'admin_inventaris_tambah_inventaris_civitas', 'uses' => 'AdminInventarisController@admin_inventaris_tambah_inventaris_civitas'));

Route::get('admin_inventaris/tambah/inventaris_jurusan', array('as' => 'admin_inventaris_tambah_inventaris_jurusan', 'uses' => 'AdminInventarisController@admin_inventaris_tambah_inventaris_jurusan'));

Route::get('admin_inventaris/tambah/inventaris_program_studi', array('as' => 'admin_inventaris_tambah_inventaris_program_studi', 'uses' => 'AdminInventarisController@admin_inventaris_tambah_inventaris_program_studi'));
...
Route::get('admin_inventaris/ubah/inventaris_civitas', array('as' => 'admin_inventaris_ubah_inventaris_civitas', 'uses' => 'AdminInventarisController@admin_inventaris_ubah_inventaris_civitas'));

Route::get('admin_inventaris/ubah/inventaris_jurusan', array('as' => 'admin_inventaris_ubah_inventaris_jurusan', 'uses' => 'AdminInventarisController@admin_inventaris_ubah_inventaris_jurusan'));

Route::get('admin_inventaris/ubah/inventaris_program_studi', array('as' => 'admin_inventaris_ubah_inventaris_program_studi', 'uses' => 'AdminInventarisController@admin_inventaris_ubah_inventaris_program_studi'));
...
Route::get('admin_inventaris/hapus/inventaris_civitas', array('as' => 'admin_inventaris_hapus_inventaris_civitas', 'uses' => 'AdminInventarisController@admin_inventaris_hapus_inventaris_civitas'));

Route::get('admin_inventaris/hapus/inventaris_jurusan', array('as' => 'admin_inventaris_hapus_inventaris_jurusan', 'uses' => 'AdminInventarisController@admin_inventaris_hapus_inventaris_jurusan'));

Route::get('admin_inventaris/hapus/inventaris_program_studi', array('as' => 'admin_inventaris_hapus_inventaris_program_studi', 'uses' => 'AdminInventarisController@admin_inventaris_hapus_inventaris_program_studi'));
...
Route::get('penerimaan/hapus/umpn', array('as' => 'penerimaan_hapus_umpn', 'uses' => 'PenerimaanController@penerimaan_hapus_umpn'));
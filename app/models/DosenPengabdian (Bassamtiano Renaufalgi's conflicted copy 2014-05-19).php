...
class DosenPengabdian extends Eloquent {
	...
	public static function ubah_pengabdian($id_dosen_pengabdian, $id_dosen, $nama_pengabdian, $tgl_mulai, $tgl_selesai, $tempat, $keterangan, $nilai){
		return DosenPengabdian::where('id_dosen_pengabdian', '=', $id_dosen_pengabdian)->update(array('id_dosen' => $id_dosen, 'nama_pengabdian' => $nama_pengabdian, 'tgl_mulai' => $tgl_mulai, 'tgl_selesai' => $tgl_selesai, 'tempat' => $tempat, 'keterangan' => $keterangan, 'nilai' => $nilai));
	}

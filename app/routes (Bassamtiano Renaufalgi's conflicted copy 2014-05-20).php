...
Route::get('admin_prodi/ubah/pengabdian_dosen', array('as' => 'admin_prodi_ubah_pengabdian_dosen', 'uses' => 'AdminProdiController@admin_prodi_ubah_pengabdian_dosen'));
 /* --------------------------------------------------
|
|	Bagian Hapus Data
|	V.0.1
...
Route::get('admin_prodi/hapus/pengabdian_dosen', array('as' => 'admin_prodi_hapus_pengabdian_dosen', 'uses' => 'AdminProdiController@admin_prodi_hapus_pengabdian_dosen'));

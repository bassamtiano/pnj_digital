<script type="text/javascript">
	function tambah_permohonan(){
		...
		$.ajax({
		 	url:"/public/dosen/tambah/permohonan",
		 	data: dataF,
		 	success:function(result){	     		
	   		}
	   	});
		dashboard_menu_active('.menu_dosen_group', '#dosen_content_dashboard', '#' + 'menu_dosen_laporan_permohonan');
	}
</script>


<div class="modal-dialog modal-lg" ng-controller="DosenBacaPermohonanController">	
	<!-- Modified Abdul Fachmi 5/14/2014 3:22PM -->
	<div class="modal-content"> <!-- awal modal content -->

		<form class="form-horizontal" id="form_tambah_permohonan" role="form" method="get" action=" {{ route('dosen_tambah_permohonan') }} ">

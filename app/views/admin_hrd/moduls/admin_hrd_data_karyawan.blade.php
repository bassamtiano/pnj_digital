		...
		<div class="col-md-12 broccoli-rowHtable">
			<table id="tbl_h" class="table table-striped table-bordered table-hover pull-downs" style="table-layout:fixed;">
				<tr>
					...
					<th class="text-center" width="15%" style="border-bottom:2px solid #000;" ng-click="predicate='id'; reverse=!reverse">ID Karyawan &nbsp; <i class="fa fa-sort"></i> </th>
					...
					<th class="text-center" width="19%" style="border-bottom:2px solid #000;" ng-click="predicate='alamat'; reverse=!reverse">Alamat &nbsp; <i class="fa fa-sort"></i>  </th>
					<th class="text-center" width="18%" style="border-bottom:2px solid #000;" ng-click="predicate='status_pegawai'; reverse=!reverse">Status Pegawai &nbsp; <i class="fa fa-sort"></i>  </th>
					<th class="text-center" width="19%" style="border-bottom:2px solid #000;" ng-click="predicate='jabatan'; reverse=!reverse">Jabatan &nbsp; <i class="fa fa-sort"></i> </th>
					<th class="text-center" width="9%" style="border-bottom:2px solid #000;" ng-click="predicate=''"> ... </th>
				</tr>
			</table>
		...
		<div class="col-md-12 broccoli-rowItable">
			<table class="table table-striped table-bordered table-hover" style="table-layout:fixed;">
				<tr ng-repeat="dk in data_karyawan | filter:query | orderBy:predicate:reverse">
					...
					<td class="text-left" width="18%">@{{ dk.status }}</td>
					<td class="text-center" width="19%">@{{ dk.status }}</td>
					<td class="text-center" width="9%"> <button class="btn btn-success btn-md" ng-click="modals_ubah_data_karyawan()"> <span class="glyphicon glyphicon-edit"></span></button> </td>
				</tr>
			</table>

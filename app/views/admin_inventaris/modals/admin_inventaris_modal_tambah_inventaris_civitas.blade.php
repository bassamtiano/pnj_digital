<script type="text/javascript">
  function tambah_inventaris_civitas(){
    var dataF = $("#form_tambah_inventaris_civitas").serialize();

    $.ajax({
      url:"/public/admin_inventaris/tambah/inventaris_civitas",
      data: dataF,
...
<div class="modal-dialog modal-md" ng-controller="AdminInventarisCivitasController">
  <div class="modal-content"> <!-- awal modal content -->
    <form class="form-horizontal" id="form_tambah_inventaris_civitas" role="form" method="get" action=" {{ route('admin_inventaris_tambah_inventaris_civitas') }} ">
      <div class="modal-header"> <!-- awal modal header -->
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <h4 class="modal-title" id="myModalLabel">Tambah Inventaris Civitas</h4>
      </div> 
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary btn-md" data-dismiss="modal" onclick="tambah_inventaris_civitas()">Submit</button>
      </div>
    </form>

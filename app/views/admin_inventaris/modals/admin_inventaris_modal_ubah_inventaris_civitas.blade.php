<script type="text/javascript">
  function ubah_inventaris_civitas(){
    var dataF = $("#form_ubah_inventaris_civitas").serialize();

    $.ajax({
      url:"/public/admin_inventaris/ubah/inventaris_civitas",
      data: dataF,
...
<div class="modal-dialog modal-md" ng-controller="AdminInventarisCivitasController">
  <div class="modal-content"> <!-- awal modal content -->
    <form class="form-horizontal" id="form_ubah_inventaris_civitas" role="form" method="get" action=" {{ route('admin_inventaris_ubah_inventaris_civitas') }} ">

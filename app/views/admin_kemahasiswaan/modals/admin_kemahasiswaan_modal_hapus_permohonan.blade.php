...
<script type="text/javascript">
	...
	function hapus_permohonan(){
		...
		dashboard_menu_active('.menu_admin_kemahasiswaan_group', '#admin_kemahasiswaan_content_dashboard', '#' + 'menu_admin_kemahasiswaan_data_permohonan');
	}
</script>
	...
	<div class="modal-content">
		...
		<!--<form method="get" action="{{ route('admin_kemahasiswaan_hapus_mahasiswa') }}">-->
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-danger btn-md" data-dismiss="modal" onclick="hapus_permohonan()"> Hapus </button>
			</div>
		</form>

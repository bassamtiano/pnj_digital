<script type="text/javascript">
  function tambah_pengabdian_dosen(){
    var dataF = $("#form_tambah_pengabdian_dosen").serialize();

    $.ajax({
      url:"/public/admin_prodi/tambah/admin_prodi_tambah_pengabdian_dosen",
      data: dataF,
...
<div class="modal-dialog modal-lg" ng-controller="AdminProdiBacaPengabdianDosen">
  <div class="modal-content">
    ...
    <form class="form-horizontal" id="form_tambah_pengabdian_dosen" role="form" method="get" action="{{ route('admin_prodi_tambah_pengabdian_dosen') }}">

      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h4 class="modal-title" id="myModalLabel">Tambah Pengabdian Dosen</h4>
      </div>
              ...
              <div id="group_data_diri" class="panel-collapse collapse in">
                <div class="panel-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="nama_pengabdian" class="form-control" id="nama_pengabdian">
                    </div>
                  </div>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-success btn-sm" data-dismiss="modal" onclick="tambah_pengabdian_dosen()">Submit</button>

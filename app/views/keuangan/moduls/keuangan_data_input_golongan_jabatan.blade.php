...
<div ng-controller="KeuanganController" id="div-controller">
	<div class="row broccoli-rowKepala">
		<h1> Data Golongan Jabatan <small> Data-data Golongan Jabatan keuangan PNJ </small> </h1>
		<br>
	...
	<div class="row broccoli-rowNavigasi broccoli-hilangPadding-semua">
		...
		<div class="col-md-2 broccoli-mojok-kanan">
			<button type="submit" class="btn btn-success form-control" ng-click="modal_tambah_data_golongan()"> <span class="glyphicon glyphicon-plus-sign"></span> Tambah</button>
		</div> <!-- Tutup col-md-2 -->
		...
		<div class="col-md-12 broccoli-rowHtable">
			<table id="tbl_h" class="table table-striped table-bordered table-hover pull-downs" style="table-layout:fixed;">
				<tr>
					...
					<th class="text-center" width="20%" style="border-bottom:2px solid #000;" ng-click="predicate='nim'; reverse=!reverse">Kode Golongan &nbsp; <i class="fa fa-sort"></i> </th>
					<th class="text-center" width="25%" style="border-bottom:2px solid #000;" ng-click="predicate='nama'; reverse=!reverse">Golongan &nbsp; <i class="fa fa-sort"></i> </th>
					<th class="text-center" width="30%" style="border-bottom:2px solid #000;" ng-click="predicate='nama_kelas'; reverse=!reverse">Gaji Golongan Jabatan &nbsp; <i class="fa fa-sort"></i>  </th>

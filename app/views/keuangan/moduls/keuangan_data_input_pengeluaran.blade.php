...
<div ng-controller="KeuanganController" id="div-controller">
	<div class="row broccoli-rowKepala">
		<h1> Data Pengeluaran <small> Akses dan Modifikasi data-data Pengeluaran PNJ </small> </h1>
		<br>
		...
		<div class="col-md-12 broccoli-rowHtable">
			<table id="tbl_h" class="table table-striped table-bordered table-hover pull-downs" style="table-layout:fixed;">
				<tr>
					...
					<th class="text-center" width="15%" style="border-bottom:2px solid #000;" ng-click="predicate='nim'; reverse=!reverse">Tanggal Masuk &nbsp; <i class="fa fa-sort"></i> </th>
					<th class="text-center" width="17%" style="border-bottom:2px solid #000;" ng-click="predicate='nama'; reverse=!reverse">Jumlah &nbsp; <i class="fa fa-sort"></i> </th>
					<th class="text-center" width="18%" style="border-bottom:2px solid #000;" ng-click="predicate='nama_kelas'; reverse=!reverse">Departemen &nbsp; <i class="fa fa-sort"></i>  </th>
					<th class="text-center" width="25%" style="border-bottom:2px solid #000;" ng-click="predicate='konsentrasi_prodi'; reverse=!reverse">Keterangan &nbsp; <i class="fa fa-sort"></i>  </th>
		...
		<div class="col-md-12 broccoli-rowItable">
			<table class="table table-striped table-bordered table-hover" style="table-layout:fixed;">
				<tr ng-repeat="dm in data_mahasiswa | filter:query | orderBy:predicate:reverse">
					...
					<td class="text-left" width="20%"> @{{ dm.nama }}</td>
					<td class="text-left" width="15%"> @{{ dm.nama_kelas }}</td>
					<td class="text-center" width="25%"> @{{ dm.nama_kelas }} </td>
